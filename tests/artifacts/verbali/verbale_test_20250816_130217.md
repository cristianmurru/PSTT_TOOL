# Verbale Test - 20250816_130217

- **tests/test_scheduler_api.py::test_scheduler_status_api**: passed (Durata: 0.02s)
...
- **tests/integration/test_api.py::TestConnectionsAPI::test_switch_connection_invalid**: failed (Durata: 0.02s)
- **tests/integration/test_api.py::TestQueriesAPI::test_get_queries**: passed (Durata: 0.02s)
- **tests/integration/test_api.py::TestQueriesAPI::test_get_query_not_found**: failed (Durata: 0.01s)
...
- **tests/integration/test_api.py::TestMonitoringAPI::test_health_check_monitoring**: passed (Durata: 0.01s)
