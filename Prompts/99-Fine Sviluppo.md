...
Esegui nell'ordine:
- esegui suite completa di test per verificare che non siano state introdotte regressioni, ricorda che abbiamo lavorato sul branch feature/R20260109.
...
- attendi mi sia disconnesso dalla vpn
- procedi con add, commit, push e dammi testo per PR
- attendi che io abbia eseguito PR, successivamente alla mia conferma allinea branch master locale ed elimina branch remoto e locale feature/R20260109 in modo che possa iniziare nuovi sviluppi su nuovo branch
- crea nuovo branch locale feature/R20260113