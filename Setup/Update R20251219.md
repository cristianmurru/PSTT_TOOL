# Sequenza installazione R20251218

Aggiornamento relativo ai commit "R20251218: UI status bar, safer preview LIMIT, scheduler timeout 600s".
Ambiente di produzione: Windows, applicazione eseguita come Servizio. Per limiti di rete l'allineamento del codice sorgente avviene manualmente tramite sovrascrittura dei file necessari.

## Novità introdotte al 2025-12-19
...
- Storico schedulazioni: non viene più troncato all'avvio. L'API `/api/scheduler/history` filtra agli ultimi 30 giorni mantenendo su file l'intero storico.
